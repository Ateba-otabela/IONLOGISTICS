      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="h-24 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Link to="/track-shipment" className="border border-blue-500 text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-blue-600 hover:text-white transition">
